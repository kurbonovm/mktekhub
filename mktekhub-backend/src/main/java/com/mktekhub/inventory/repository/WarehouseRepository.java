...
/**
 * Repository interface for Warehouse entity. Provides database operations for warehouse management.
 */
@Repository
public interface WarehouseRepository extends JpaRepository<Warehouse, Long> {
  ...
  @Query(
      "SELECT w FROM Warehouse w WHERE (w.currentCapacity * 100.0 / w.maxCapacity) >= w.capacityAlertThreshold")
