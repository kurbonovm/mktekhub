...
/**
 * Repository interface for InventoryItem entity. Provides database operations for inventory
 * management.
 */
@Repository
public interface InventoryItemRepository extends JpaRepository<InventoryItem, Long> {
  ...
  @Query(
      "SELECT i FROM InventoryItem i WHERE i.reorderLevel IS NOT NULL AND i.quantity <= i.reorderLevel")
  ...
  /**
   * Find an inventory item by SKU and warehouse ID. Used for checking if an item already exists in
   * a warehouse during transfers.
   */
