...
public class WarehouseCapacityExceededException extends RuntimeException {
    ...
    public WarehouseCapacityExceededException(String warehouseName, BigDecimal available, BigDecimal requested) {
        super(String.format("Warehouse '%s' capacity exceeded. Available capacity: %.2f ft³, Requested: %.2f ft³",
