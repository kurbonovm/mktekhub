...
/**
 * Initialize default data on application startup. Creates roles, warehouses, and sample inventory
 * items with various scenarios.
 */
@Component
public class DataInitializer implements CommandLineRunner {
  ...
  private void seedInventoryItems() {
    ...
    Warehouse westCoast =
        warehouseRepository.findByName("West Coast Distribution Center").orElseThrow();
