...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedWarehouses() {
        ...
        warehouse1.setMaxCapacity(10000);
        warehouse1.setCurrentCapacity(0);
        ...
        warehouse2.setMaxCapacity(15000);
        ...
        warehouse3.setMaxCapacity(8000);
        warehouse3.setCurrentCapacity(0);
    ...
    private void seedInventoryItems() {
        ...
        createItem("ELEC-003", "iPhone 15 Pro", "Latest flagship smartphone",
                "Electronics", "Apple", 50, 15, 999.99, westCoast,
