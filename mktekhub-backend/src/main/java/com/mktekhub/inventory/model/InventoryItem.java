...
/**
 * Entity representing an inventory item in the mktekhub inventory management system. Items are
 * stored in warehouses and tracked through stock activities. Same SKU can exist in multiple
 * warehouses (composite unique on sku + warehouse_id).
 */
@Entity
@Table(
    name = "inventory_item",
