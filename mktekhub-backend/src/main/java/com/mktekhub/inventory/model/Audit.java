...
/**
 * Entity representing an audit log entry in the mktekhub inventory management system. Tracks all
 * create, update, and delete operations across entities for compliance and debugging.
 */
@Entity
@Table(name = "audit")
public class Audit {
