...
/**
 * Entity representing a stock activity in the mktekhub inventory management system.
 * Tracks all inventory movements, transfers, and adjustments for audit purposes.
 */
@Entity
...
public class StockActivity {
    ...
    public StockActivity(InventoryItem item, ActivityType activityType, Integer quantityChange, User performedBy) {
        this.item = item;
