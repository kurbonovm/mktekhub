...
/**
 * Entity representing a warehouse in the mktekhub inventory management system. Warehouses store
 * inventory items and have volume-based capacity limits and alert thresholds. Capacity is measured
 * in cubic feet.
 */
@Entity
