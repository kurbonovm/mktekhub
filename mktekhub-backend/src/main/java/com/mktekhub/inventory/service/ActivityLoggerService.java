...
/**
 * Service for logging stock activities consistently across the application.
 * Eliminates code duplication in activity logging.
 */
@Service
public class ActivityLoggerService {
    ...
    public StockActivity logAdjustment(
        ...
        String notes = "Manual quantity adjustment: " +
     ...
     */
    public StockActivity logUpdate(
            InventoryItem item,
            User performedBy,
            String notes) {
