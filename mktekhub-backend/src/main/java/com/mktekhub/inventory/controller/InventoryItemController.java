...
public class InventoryItemController {
  ...
  /** Get all inventory items. Accessible by all authenticated users. GET /api/inventory */
  @GetMapping
  ...
  /** Get inventory item by ID. Accessible by all authenticated users. GET /api/inventory/{id} */
  @GetMapping("/{id}")
  @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER', 'VIEWER')")
  ...
  /**
   * Get inventory item by SKU. Accessible by all authenticated users. GET /api/inventory/sku/{sku}
   */
  @GetMapping("/sku/{sku}")
  @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER', 'VIEWER')")
  ...
  /**
   * Get all items in a specific warehouse. Accessible by all authenticated users. GET
   * /api/inventory/warehouse/{warehouseId}
   */
  @GetMapping("/warehouse/{warehouseId}")
  @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER', 'VIEWER')")
  public ResponseEntity<List<InventoryItemResponse>> getItemsByWarehouse(
  ...
  /**
   * Get all items by category. Accessible by all authenticated users. GET
   * /api/inventory/category/{category}
   */
  @GetMapping("/category/{category}")
  @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER', 'VIEWER')")
  public ResponseEntity<List<InventoryItemResponse>> getItemsByCategory(
  ...
  /**
   * Get all low stock items. Accessible by ADMIN and MANAGER. GET /api/inventory/alerts/low-stock
   */
  ...
  /** Get all expired items. Accessible by ADMIN and MANAGER. GET /api/inventory/alerts/expired */
  ...
  /**
   * Get items expiring within specified days. Accessible by ADMIN and MANAGER. GET
  ...
  /** Create a new inventory item. Accessible by ADMIN and MANAGER only. POST /api/inventory */
  @PostMapping
  @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER')")
  ...
  /**
   * Update an existing inventory item. Accessible by ADMIN and MANAGER only. PUT
   * /api/inventory/{id}
   */
  @PutMapping("/{id}")
  @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER')")
  ...
  /** Delete an inventory item. Accessible by ADMIN and MANAGER only. DELETE /api/inventory/{id} */
  @DeleteMapping("/{id}")
  @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER')")
  ...
  /**
   * Adjust inventory quantity. Accessible by ADMIN and MANAGER only. PATCH
