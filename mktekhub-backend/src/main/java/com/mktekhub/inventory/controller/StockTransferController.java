...
public class StockTransferController {
  ...
  /** Transfer inventory between warehouses Requires ADMIN or MANAGER role */
  @PostMapping
  @PreAuthorize("hasRole('ADMIN') or hasRole('MANAGER')")
  @Operation(
      summary = "Transfer stock between warehouses",
      description =
          "Transfer inventory items from one warehouse to another with automatic capacity checking and activity logging")
  ...
  /** Perform bulk stock transfers Requires ADMIN or MANAGER role */
  @PostMapping("/bulk")
  @PreAuthorize("hasRole('ADMIN') or hasRole('MANAGER')")
  @Operation(
      summary = "Perform bulk stock transfers",
      description =
          "Transfer multiple inventory items in one request. Returns success and failure details for each transfer.")
