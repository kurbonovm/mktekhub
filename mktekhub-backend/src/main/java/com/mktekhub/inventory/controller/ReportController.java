...
public class ReportController {
    ...
    public ResponseEntity<byte[]> generateWarehouseUtilizationReport() {
        ...
        String filename = "warehouse_utilization_" + LocalDateTime.now().format(FILENAME_FORMATTER) + ".csv";
    ...
    public ResponseEntity<byte[]> generateInventorySummaryByCategory() {
        ...
        String filename = "inventory_by_category_" + LocalDateTime.now().format(FILENAME_FORMATTER) + ".csv";
    ...
    public ResponseEntity<byte[]> generateFilteredStockActivityReport(
        ...
        byte[] csvData = reportService.generateFilteredStockActivityReport(
        ...
        String filename = "filtered_stock_activity_" + LocalDateTime.now().format(FILENAME_FORMATTER) + ".csv";
    ...
    public ResponseEntity<byte[]> generateFilteredInventoryValuationReport(
        ...
        byte[] csvData = reportService.generateFilteredInventoryValuationReport(
            Optional.ofNullable(category),
            Optional.ofNullable(brand),
            Optional.ofNullable(warehouseId)
        );

        String filename = "filtered_inventory_valuation_" + LocalDateTime.now().format(FILENAME_FORMATTER) + ".csv";
