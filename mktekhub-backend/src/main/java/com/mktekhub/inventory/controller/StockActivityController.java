...
public class StockActivityController {
    ...
    @Operation(summary = "Get all stock activities", description = "Retrieve all stock activity records")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN') or hasRole('MANAGER') or hasRole('VIEWER')")
    @Operation(summary = "Get activity by ID", description = "Retrieve a specific stock activity by its ID")
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('MANAGER') or hasRole('VIEWER')")
    @Operation(summary = "Get activities by item ID",
               description = "Retrieve all stock activities for a specific inventory item (sorted by timestamp)")
    public ResponseEntity<List<StockActivityResponse>> getActivitiesByItemId(@PathVariable Long itemId) {
    ...
    @GetMapping("/sku/{sku}")
    @PreAuthorize("hasRole('ADMIN') or hasRole('MANAGER') or hasRole('VIEWER')")
    @Operation(summary = "Get activities by SKU",
               description = "Retrieve all stock activities for an item by its SKU")
    public ResponseEntity<List<StockActivityResponse>> getActivitiesByItemSku(@PathVariable String sku) {
    ...
    @Operation(summary = "Get activities by type",
               description = "Retrieve activities filtered by type (RECEIVE, TRANSFER, SALE, ADJUSTMENT, DELETE)")
    ...
    public ResponseEntity<List<StockActivityResponse>> getActivitiesByUserId(@PathVariable Long userId) {
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('MANAGER')")
    @Operation(summary = "Get activities by username",
               description = "Retrieve all activities performed by a specific user (by username)")
    public ResponseEntity<List<StockActivityResponse>> getActivitiesByUsername(@PathVariable String username) {
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('MANAGER') or hasRole('VIEWER')")
    @Operation(summary = "Get activities by warehouse",
               description = "Retrieve all activities related to a warehouse (as source or destination)")
    public ResponseEntity<List<StockActivityResponse>> getActivitiesByWarehouse(@PathVariable Long warehouseId) {
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('MANAGER') or hasRole('VIEWER')")
    @Operation(summary = "Get activities by source warehouse",
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('MANAGER') or hasRole('VIEWER')")
    @Operation(summary = "Get activities by destination warehouse",
    ...
    @GetMapping("/filter")
    @PreAuthorize("hasRole('ADMIN') or hasRole('MANAGER') or hasRole('VIEWER')")
    @Operation(summary = "Get activities with filters",
               description = "Retrieve activities using multiple optional filters (item, type, user, warehouse, date range)")
    public ResponseEntity<List<StockActivityResponse>> getActivitiesWithFilters(
            ...
            @RequestParam(required = false) @Parameter(description = "Activity type") ActivityType activityType,
            ...
            @Parameter(description = "Start date-time (ISO format: yyyy-MM-dd'T'HH:mm:ss)") LocalDateTime startDate,
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)
            @Parameter(description = "End date-time (ISO format: yyyy-MM-dd'T'HH:mm:ss)") LocalDateTime endDate) {

        return ResponseEntity.ok(stockActivityService.getActivitiesWithFilters(
