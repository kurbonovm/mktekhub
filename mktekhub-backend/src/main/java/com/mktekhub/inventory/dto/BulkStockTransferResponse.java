...
public class BulkStockTransferResponse {
    ...
    public BulkStockTransferResponse(int totalTransfers, int successfulTransfers, int failedTransfers,
                                     List<StockTransferResponse> successResults, List<TransferError> errors) {
