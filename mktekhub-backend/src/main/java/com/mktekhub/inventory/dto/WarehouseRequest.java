...
/** DTO for creating or updating a warehouse. Max capacity is measured in cubic feet. */
public class WarehouseRequest {
  ...
  public WarehouseRequest(
      String name, String location, BigDecimal maxCapacity, BigDecimal capacityAlertThreshold) {
    this.name = name;
