...
class StockTransferControllerTest {
  ...
  void bulkTransferStock_Success() throws Exception {
    ...
    BulkStockTransferResponse bulkResponse =
        new BulkStockTransferResponse(
  ...
  void bulkTransferStock_PartialSuccess() throws Exception {
    ...
    BulkStockTransferResponse partialResponse =
        new BulkStockTransferResponse(2, 1, 1, Collections.singletonList(transferResponse), errors);
  ...
  void bulkTransferStock_AllFailures() throws Exception {
    ...
    BulkStockTransferResponse failureResponse =
        new BulkStockTransferResponse(1, 0, 1, Collections.emptyList(), errors);
  ...
  void bulkTransferStock_EmptyList() throws Exception {
    ...
    BulkStockTransferResponse emptyResponse =
        new BulkStockTransferResponse(0, 0, 0, Collections.emptyList(), Collections.emptyList());
