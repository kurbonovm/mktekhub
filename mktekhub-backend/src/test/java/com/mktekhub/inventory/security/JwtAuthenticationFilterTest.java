...
/**
 * Comprehensive unit tests for JwtAuthenticationFilter. Tests JWT token extraction, validation, and
...
class JwtAuthenticationFilterTest {
  ...
  void doFilterInternal_ValidToken_SetsAuthenticationDetails()
  ...
  void doFilterInternal_NoAuthorizationHeader_NoAuthentication()
      throws ServletException, IOException {
    // Arrange
  ...
  void doFilterInternal_EmptyAuthorizationHeader_NoAuthentication()
      throws ServletException, IOException {
    // Arrange
  ...
  void doFilterInternal_TokenWithoutBearerPrefix_NoAuthentication()
      throws ServletException, IOException {
    // Arrange
  ...
  void doFilterInternal_MalformedBearerToken_NoAuthentication()
      throws ServletException, IOException {
    // Arrange
  ...
  void doFilterInternal_BearerTokenOnlySpace_NoAuthentication()
      throws ServletException, IOException {
    // Arrange
    when(request.getHeader("Authorization")).thenReturn("Bearer ");
  ...
  void doFilterInternal_JwtUtilThrowsException_ContinuesFilterChain()
      throws ServletException, IOException {
    // Arrange
  ...
  void doFilterInternal_UserDetailsServiceThrowsException_ContinuesFilterChain()
      throws ServletException, IOException {
    // Arrange
  ...
  void doFilterInternal_GetUsernameThrowsException_ContinuesFilterChain()
      throws ServletException, IOException {
    // Arrange
    String token = "valid-token";
    when(request.getHeader("Authorization")).thenReturn("Bearer " + token);
    ...
    when(jwtUtil.getUsernameFromToken(token))
        .thenThrow(new RuntimeException("Cannot extract username"));
  ...
  void doFilterInternal_CaseSensitiveBearerPrefix_HandlesCorrectly()
      throws ServletException, IOException {
  ...
  void doFilterInternal_ExtraSpacesInBearer_ExtractsTokenCorrectly()
      throws ServletException, IOException {
    // Arrange
    String token = "valid-jwt-token";
