...
/**
 * Comprehensive unit tests for JwtUtil. Tests token generation, validation, expiration, and error
 * handling.
 */
...
class JwtUtilTest {
  ...
  void validateToken_UnsupportedJwt_ReturnsFalse() {
    ...
    String unsupportedToken = Jwts.builder().subject("testuser").compact(); // No signature
