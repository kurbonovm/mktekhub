...
/**
 * Comprehensive unit tests for GlobalExceptionHandler. Tests all exception handlers and response
 * formatting.
 */
...
class GlobalExceptionHandlerTest {
  ...
  void handleResourceNotFoundException_IncludesCustomMessage() {
    ...
    ResourceNotFoundException exception =
        new ResourceNotFoundException("Warehouse not found with id: 999");
  ...
  void handleDuplicateResourceException_Returns409() {
    ...
    DuplicateResourceException exception =
        new DuplicateResourceException("User with username 'testuser' already exists");

    // Act
    ResponseEntity<ErrorResponse> response =
        globalExceptionHandler.handleDuplicateResourceException(exception, request);
  ...
  void handleDuplicateResourceException_DuplicateSku() {
    // Arrange
    DuplicateResourceException exception =
        new DuplicateResourceException("Item with SKU 'ELEC-001' already exists");
  ...
  void handleInsufficientStockException_Returns400() {
    ...
    InsufficientStockException exception =
        new InsufficientStockException("Insufficient stock. Required: 10, Available: 5");
  ...
  @Test
  @DisplayName(
      "Handle WarehouseCapacityExceededException - Should return 400 with correct error response")
  void handleWarehouseCapacityExceededException_Returns400() {
    // Arrange
    WarehouseCapacityExceededException exception =
        new WarehouseCapacityExceededException(
            "Warehouse capacity exceeded. Max: 1000, Current: 950, Adding: 100");

    // Act
    ResponseEntity<ErrorResponse> response =
        globalExceptionHandler.handleWarehouseCapacityExceededException(exception, request);
  ...
  void handleInvalidOperationException_Returns400() {
    ...
    InvalidOperationException exception =
        new InvalidOperationException("Cannot delete warehouse with existing inventory items");

    // Act
    ResponseEntity<ErrorResponse> response =
        globalExceptionHandler.handleInvalidOperationException(exception, request);
    ...
    assertEquals(
        "Cannot delete warehouse with existing inventory items", errorResponse.getMessage());
    assertEquals("/api/test", errorResponse.getPath());
  }
  ...
  void handleValidationException_Returns400WithValidationErrors() {
    ...
    FieldError fieldError2 =
        new FieldError("inventoryItem", "quantity", "Quantity must be positive");
    ...
    // Act
    ResponseEntity<ErrorResponse> response =
        globalExceptionHandler.handleValidationException(methodArgumentNotValidException, request);
  ...
  @Test
  @DisplayName(
      "Handle MethodArgumentNotValidException - Should handle multiple errors on same field")
  ...
  void handleBadCredentialsException_Returns401WithGenericMessage() {
    ...
    ErrorResponse errorResponse = response.getBody();
    assertNotNull(errorResponse);
    // Should return generic message for security (don't reveal whether username or password is
    // wrong)
    assertEquals("Invalid username or password", errorResponse.getMessage());
  }
  ...
  void handleGlobalException_Returns500() {
    ...
    // Act
    ResponseEntity<ErrorResponse> response =
        globalExceptionHandler.handleGlobalException(exception, request);
    ...
    assertEquals(
        "An unexpected error occurred. Please try again later.", errorResponse.getMessage());
    assertEquals("/api/test", errorResponse.getPath());
  }
  ...
  void errorResponses_ConsistentStructure() {
    ...
    ResponseEntity<ErrorResponse> response1 =
        globalExceptionHandler.handleResourceNotFoundException(notFoundEx, request);
    ...
    ResponseEntity<ErrorResponse> response2 =
        globalExceptionHandler.handleDuplicateResourceException(duplicateEx, request);
    ...
    ResponseEntity<ErrorResponse> response3 =
        globalExceptionHandler.handleInvalidOperationException(invalidEx, request);
