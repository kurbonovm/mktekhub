 ...
 * Tests CORS filter configuration for frontend requests.
 */
...
class CorsConfigTest {
    ...
    /**
     * Extracts CorsConfiguration from CorsFilter using reflection.
     * This is necessary because Spring's CorsFilter doesn't expose its configuration directly.
     */
     ...
     */
    private UrlBasedCorsConfigurationSource extractConfigurationSource(CorsFilter corsFilter) throws Exception {
        Field configSourceField = CorsFilter.class.getDeclaredField("configSource");
        configSourceField.setAccessible(true);
