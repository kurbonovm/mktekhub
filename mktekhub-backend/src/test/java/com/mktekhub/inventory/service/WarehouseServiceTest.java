...
/**
 * Comprehensive unit tests for WarehouseService. Tests all CRUD operations and warehouse management
 * functionality.
 */
...
class WarehouseServiceTest {
  ...
  void getWarehouseById_NotFound() {
    ...
    ResourceNotFoundException exception =
        assertThrows(
            ResourceNotFoundException.class, () -> warehouseService.getWarehouseById(999L));
  ...
  void createWarehouse_Success() {
    ...
    assertEquals(
        warehouseRequest.getCapacityAlertThreshold(), savedWarehouse.getCapacityAlertThreshold());
  ...
  @Test
  @DisplayName(
      "DeleteWarehouse - Should throw InvalidOperationException when warehouse has inventory")
  ...
  @Test
  @DisplayName(
      "HardDeleteWarehouse - Should throw InvalidOperationException when warehouse has inventory")
  void hardDeleteWarehouse_HasInventory() {
    ...
    InvalidOperationException exception =
        assertThrows(
            InvalidOperationException.class, () -> warehouseService.hardDeleteWarehouse(1L));
  ...
  void hardDeleteWarehouse_NotFound() {
    ...
    ResourceNotFoundException exception =
        assertThrows(
            ResourceNotFoundException.class, () -> warehouseService.hardDeleteWarehouse(999L));
