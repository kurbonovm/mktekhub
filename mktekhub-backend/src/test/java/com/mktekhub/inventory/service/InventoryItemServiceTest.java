...
class InventoryItemServiceTest {
  ...
  @Mock private ActivityLoggerService activityLoggerService;
  ...
  void createItem_DuplicateSKU() {
    ...
    // Act & Assert
    assertThrows(
        DuplicateResourceException.class, () -> inventoryItemService.createItem(itemRequest));
  }
  ...
  void createItem_WarehouseNotFound() {
    ...
    // Act & Assert
    assertThrows(
        ResourceNotFoundException.class, () -> inventoryItemService.createItem(itemRequest));
  }
  ...
  void adjustQuantity_NegativeResult() {
    ...
    // Act & Assert
    assertThrows(
        InvalidOperationException.class, () -> inventoryItemService.adjustQuantity(1L, -150));
  }
