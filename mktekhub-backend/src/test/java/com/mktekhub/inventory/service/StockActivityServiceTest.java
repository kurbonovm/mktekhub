...
class StockActivityServiceTest {
    ...
    void getActivityById_NotFound() {
        ...
        assertThrows(ResourceNotFoundException.class,
            () -> stockActivityService.getActivityById(999L));
    }
    ...
    void getActivitiesByItemId_ItemNotFound() {
        ...
        // Act & Assert
        assertThrows(ResourceNotFoundException.class,
            () -> stockActivityService.getActivitiesByItemId(999L));
    }
    ...
    void getActivitiesByType_Success() {
        ...
        // Act
        List<StockActivityResponse> result = stockActivityService.getActivitiesByType(ActivityType.RECEIVE);
    ...
    void getActivitiesByUserId_UserNotFound() {
        ...
        // Act & Assert
        assertThrows(ResourceNotFoundException.class,
            () -> stockActivityService.getActivitiesByUserId(999L));
    }
    ...
    @Test
    @DisplayName("GetActivitiesByDestinationWarehouse - Should return destination warehouse activities")
