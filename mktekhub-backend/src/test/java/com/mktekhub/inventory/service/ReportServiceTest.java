...
class ReportServiceTest {
    ...
    void exportStockActivitiesToCSV_EmptyList() {
        ...
        assertNotNull(result);
        String csv = new String(result);
        assertTrue(csv.contains("Timestamp,Item SKU,Item Name,Activity Type")); // Header should be present
    ...
    void generateStockMovementReport_Success() {
        // Arrange
        when(stockActivityRepository.findAll())
    ...
    void generateFilteredStockActivityReport_WithFilters() {
        ...
        // Act
        byte[] result = reportService.generateFilteredStockActivityReport(
    ...
    void generateFilteredInventoryValuationReport_WithCategory() {
        ...
        // Act
        byte[] result = reportService.generateFilteredInventoryValuationReport(
