...
describe('InventoryMobileCard', () => {
  ...
  describe('Empty State', () => {
    ...
    it('should show appropriate message without filters', () => {
      render(<InventoryMobileCard {...defaultProps} items={[]} hasActiveFilters={false} />);
    ...
    it('should show appropriate message with filters', () => {
      render(<InventoryMobileCard {...defaultProps} items={[]} hasActiveFilters={true} />);
  ...
  describe('Card Content', () => {
    ...
    it('should handle missing category', () => {
      ...
      render(<InventoryMobileCard {...defaultProps} items={[itemWithoutCategory]} />);
  ...
  describe('Low Stock Badge', () => {
    ...
    it('should not show low stock badge when quantity above reorder level', () => {
      ...
      render(<InventoryMobileCard {...defaultProps} items={[normalStockItem]} />);
    ...
    it('should handle items without reorder level', () => {
      ...
      render(<InventoryMobileCard {...defaultProps} items={[itemWithoutReorderLevel]} />);
  ...
  describe('Actions for Regular Users', () => {
    it('should not show action buttons for regular users', () => {
      render(<InventoryMobileCard {...defaultProps} isAdminOrManager={false} />);
  ...
  describe('Card Structure', () => {
    it('should render correct number of cards', () => {
      ...
      const cards = container.querySelectorAll('.rounded-lg.bg-white.p-4.shadow');
