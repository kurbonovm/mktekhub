...
import { ExpirationBadge, WarrantyBadge } from '@/components/common/ExpirationBadge';
...
describe('ExpirationBadge', () => {
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle invalid date strings gracefully', () => {
      const { container } = render(<ExpirationBadge expirationDate="invalid-date" />);
    ...
    it('should handle dates exactly on the warning threshold', () => {
      ...
      render(<ExpirationBadge expirationDate={date30DaysAway} warningDays={30} />);
...
describe('WarrantyBadge', () => {
  ...
  describe('Warranty Expiring Soon', () => {
    it('should display warning when warranty expires within 60 days', () => {
      ...
      render(<WarrantyBadge warrantyEndDate={soonDate} isWarrantyValid={true} />);
    ...
    it('should use singular "day" for 1 day remaining', () => {
      ...
      render(<WarrantyBadge warrantyEndDate={tomorrow} isWarrantyValid={true} />);
    ...
    it('should show warning at exactly 60 days', () => {
      ...
      render(<WarrantyBadge warrantyEndDate={date60DaysAway} isWarrantyValid={true} />);
  ...
  describe('Edge Cases', () => {
    it('should handle warranty at exactly the threshold (61 days)', () => {
      ...
      const { container } = render(
        <WarrantyBadge warrantyEndDate={date61DaysAway} isWarrantyValid={true} />
      );
