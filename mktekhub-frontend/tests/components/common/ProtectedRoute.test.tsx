...
describe('ProtectedRoute', () => {
  ...
  describe('Loading State', () => {
    ...
    it('should display loading in centered container', () => {
      ...
      const loadingContainer = container.querySelector('.flex.h-screen.items-center.justify-center');
  ...
  describe('Access Denied Styling', () => {
    ...
    it('should center access denied message', () => {
      ...
      const deniedContainer = container.querySelector('.flex.h-screen.items-center.justify-center');
