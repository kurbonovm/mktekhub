...
describe("Navbar", () => {
  ...
  describe("Desktop Navigation", () => {
    it("should render all common navigation links", () => {
      ...
      expect(
        screen.getAllByRole("link", { name: "Warehouses" })[0],
      ).toBeInTheDocument();
      expect(
        screen.getAllByRole("link", { name: "Inventory" })[0],
      ).toBeInTheDocument();
      expect(
        screen.getAllByRole("link", { name: "Activity" })[0],
      ).toBeInTheDocument();
      expect(
        screen.getAllByRole("link", { name: "Reports" })[0],
      ).toBeInTheDocument();
      expect(
        screen.getAllByRole("link", { name: "Custom Reports" })[0],
      ).toBeInTheDocument();
    });
    ...
    it("should not show admin links for regular users", () => {
      ...
      const stockTransferLinks = screen.queryAllByRole("link", {
        name: "Stock Transfer",
      });
      const bulkTransferLinks = screen.queryAllByRole("link", {
        name: "Bulk Transfer",
      });
    ...
    it("should show admin links for admin users", () => {
      ...
      expect(
        screen.getAllByRole("link", { name: "Stock Transfer" }).length,
      ).toBeGreaterThan(0);
      expect(
        screen.getAllByRole("link", { name: "Bulk Transfer" }).length,
      ).toBeGreaterThan(0);
    });
  ...
  describe("Active Link Styling", () => {
    ...
    it("should not highlight inactive links", () => {
      ...
      expect(inventoryLinks[0].className).not.toContain(
